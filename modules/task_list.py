...
#             uncompleted_list.append(item["description"])
...
def get_completed_tasks(list):
    ...
    for item in list:
        if item["completed"] == True:
            completed_list.append(item["description"])
...
def get_uncompleted_tasks(list):
    get_tasks_by_status(list, False)
